               ...
               <div class="one-half column">
                    <div class="copyright">
                         ...
                         <?php if (get_theme_mod('mp_footer_tos_page')) {?>
                              <p><a href="<?php the_permalink(get_theme_mod('mp_footer_tos_page'));?>"><?php _e('Terms of Services','mars'); ?></a></p>
                         <?php } ?>

                         <?php if (get_theme_mod('mp_footer_privacy_page')) {?>
                              <p><a href="<?php the_permalink(get_theme_mod('mp_footer_privacy_page'));?>"><?php _e('Privacy Policy','mars'); ?></a></p>
                         <?php } ?>
                    </div>
               </div>
            </div>
