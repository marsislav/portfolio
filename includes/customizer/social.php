<?php
    function mp_social_customizer_section ($wp_customize) {
        ...
        $wp_customize->add_section('mp_social_section', [
            'title'=> __('Marsislav Portfolio Social settings', 'mars'),
            'priority'=>30
        ]);
         $wp_customize->add_control(new WP_Customize_Control(
             ...
             $wp_customize->add_control(new WP_Customize_Control(
                ...
                $wp_customize->add_control(new WP_Customize_Control(
                    ...
                    array (
                       'label' => __('Instagram Handle', 'mars'),
                       'section' => 'mp_social_section',
                    ...
                    $wp_customize->add_control(new WP_Customize_Control(
                        ...
                        $wp_customize->add_control(new WP_Customize_Control(
                            ...
                            $wp_customize->add_control(new WP_Customize_Control(
                                ...
                                'mp_phone_number',
                                array (
                                   'label' => __('Phone Number Handle', 'mars'),
                                   'section' => 'mp_social_section',
